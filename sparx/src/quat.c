...
void
QuatMultQuat (const quat4_t qa, const quat4_t qb, quat4_t out)
{
...
void
QuatMultVec (const quat4_t q, const vec3_t v, quat4_t out)
{
...
void
QuatRotatePoint (const quat4_t q, const vec3_t in, vec3_t out)
{
  ...
  QuatMultVec (q, in, tmp);
  QuatMultQuat (tmp, inv, final);
